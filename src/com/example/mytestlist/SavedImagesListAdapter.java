...
public class SavedImagesListAdapter extends BaseAdapter implements ListAdapter {
    private static String LOG_TAG = "SavedImagesListAdapter";
    private ImageDb mDb;
    ArrayList<SavedWallpaperTile> mImages;
    Context mContext;
    LayoutInflater mLayoutInflater;

    public static class SavedWallpaperTile extends WallpaperTile {
        private int mDbId;
        public SavedWallpaperTile(int dbId, File target, Drawable thumb) {
            super(target, thumb, WallpaperTile.Type.saved);
            mDbId = dbId;
        }
...
/*        @Override
    ...
    public SavedImagesListAdapter(Activity context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Drawable thumbDrawable = mImages.get(position).getThumbnail();
        if (thumbDrawable == null) {
            Log.e(LOG_TAG, "Error decoding thumbnail for wallpaper #" + position);
        }
        
        View view;

        if (convertView == null) {
            view = mLayoutInflater.inflate(R.layout.wallpaper_picker_saved_image_item, parent, false);
        } else {
            view = convertView;
        }
    ...
    public void writeImage(Bitmap thumbnail, byte[] imageBytes) {
        try {
            ...
            Log.e(LOG_TAG, "Failed writing images to storage " + e);
        }
    }
    ...
    static class ImageDb extends SQLiteOpenHelper {
        ...
        public ImageDb(Context context) {
            super(context, context.getDatabasePath("saved_wallpaper_images.db").getPath(),
                    null, DB_VERSION);
