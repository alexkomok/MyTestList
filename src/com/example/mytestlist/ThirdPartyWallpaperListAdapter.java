...
public class ThirdPartyWallpaperListAdapter extends BaseAdapter implements ListAdapter {

    private final LayoutInflater mInflater;
    private final PackageManager mPackageManager;
    private final int mIconSize;

    private List<WallpaperTile> thirdPartyWallpapers =
...
/*
    ...
    public ThirdPartyWallpaperListAdapter(Context context) {
        ...
        for (ResolveInfo info : apps) {
            ...
            thirdPartyWallpapers.add(new WallpaperTile(info, WallpaperTile.Type.thirdparty));
        }
    }

    public int getCount() {
        return thirdPartyWallpapers.size();
    }

    public WallpaperTile getItem(int position) {
        return thirdPartyWallpapers.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            view = mInflater.inflate(R.layout.wallpaper_picker_tirdparty_wallpaper_item, parent, false);
        } else {
            view = convertView;
        }


        ResolveInfo info = thirdPartyWallpapers.get(position).getResolveInfo();
